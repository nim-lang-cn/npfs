...
proc registerAlarmApproximateDelta(eps: EpollServer, deltaInus: int64, ac: ptr AlarmCB) = 
...
proc waitForEventsAndCallHandleEvents(eps: EpollServer, timeoutInus: int64, events: seq[EpollEvent])
...
proc onRegistration*(eci: EpollAlarmCallbackInterface, token: alarmRegToken, eps: EpollServer) = discard
